  ...
  return (
    <div className='related'>
      ...
      <div className='related__product' data-test-id='related-slider'>
        ...
        >
          { p.DataRelated.map (Card => <SwiperSlide><ProductCard id={ Card.id } name={ Card.name } price={ Card.price } star={ Card.star } images= {Card.images[0].url } category={ Card.category } rating={ Card.rating } discount= { Card.discount }/></SwiperSlide>)}
        </Swiper>
      </div>
    </div>
  );
